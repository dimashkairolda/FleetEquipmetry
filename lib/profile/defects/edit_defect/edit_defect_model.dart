...
import '/index.dart';
import 'edit_defect_widget.dart' show EditDefectWidget;
import 'package:flutter/material.dart';

class EditDefectModel extends FlutterFlowModel<EditDefectWidget> {
  ...
  // Stores action output result for [Backend Call - API (editDefect)] action in Container widget.
  ApiCallResponse? asasa;
  // Stores action output result for [Backend Call - API (editDefect)] action in Container widget.
  ...
  bool isDataUploading_wwwdq = false;
  FFUploadedFile uploadedLocalFile_wwwdq =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  // Stores action output result for [Backend Call - API (UploadPhotos)] action in Container1 widget.
  ApiCallResponse? apiResultsy651;
