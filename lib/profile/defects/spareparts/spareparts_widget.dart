...
import '/profile/defects/add_t_m_c/add_t_m_c_widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'spareparts_model.dart';
export 'spareparts_model.dart';
...
class SparepartsWidget extends StatefulWidget {
  ...
  static String routeName = 'spareparts';
  static String routePath = '/spareparts';
...
class _SparepartsWidgetState extends State<SparepartsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SparepartsModel());
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Builder(
                  builder: (context) {
                    final todo = FFAppState().spareparts.toList();
