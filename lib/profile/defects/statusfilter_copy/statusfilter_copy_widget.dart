...
import 'statusfilter_copy_model.dart';
export 'statusfilter_copy_model.dart';

class StatusfilterCopyWidget extends StatefulWidget {
  const StatusfilterCopyWidget({super.key});

  @override
  State<StatusfilterCopyWidget> createState() => _StatusfilterCopyWidgetState();
}

class _StatusfilterCopyWidgetState extends State<StatusfilterCopyWidget> {
  late StatusfilterCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatusfilterCopyModel());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FlutterFlowRadioButton(
                    options: ['Исправный', 'Неисправный'].toList(),
                    onChanged: (val) async {
                      safeSetState(() {});
                      FFAppState().statusfilter =
                        ...
                        onPressed: () async {
                          FFAppState().searchOutput1 = functions
                              .filterSCopy(
                                  ...
                                  functions
                                      .statuspark(FFAppState().statusfilter),
