...
import 'motohours_reglament_model.dart';
export 'motohours_reglament_model.dart';

class MotohoursReglamentWidget extends StatefulWidget {
  const MotohoursReglamentWidget({
    super.key,
    required this.json,
  ...
  @override
  State<MotohoursReglamentWidget> createState() =>
      _MotohoursReglamentWidgetState();
}

class _MotohoursReglamentWidgetState extends State<MotohoursReglamentWidget> {
  late MotohoursReglamentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MotohoursReglamentModel());
                              ...
                              return Padding(
                                ...
                                child: Container(
                                  ...
                                  child: AddsWidget(
                                    ...
                                    actions: functions.getActionsForValue(
                                        getJsonField(
                                          widget.json,
                                          r'''$.logics''',
                                        ),
