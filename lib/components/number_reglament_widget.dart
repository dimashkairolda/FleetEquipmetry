...
import 'number_reglament_model.dart';
export 'number_reglament_model.dart';

class NumberReglamentWidget extends StatefulWidget {
  const NumberReglamentWidget({
    super.key,
    required this.json,
  ...
  @override
  State<NumberReglamentWidget> createState() => _NumberReglamentWidgetState();
}

class _NumberReglamentWidgetState extends State<NumberReglamentWidget> {
  late NumberReglamentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NumberReglamentModel());
