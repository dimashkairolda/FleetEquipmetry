...
import 'scale_reglament_model.dart';
export 'scale_reglament_model.dart';

class ScaleReglamentWidget extends StatefulWidget {
  const ScaleReglamentWidget({
    super.key,
    required this.json,
  ...
  @override
  State<ScaleReglamentWidget> createState() => _ScaleReglamentWidgetState();
}

class _ScaleReglamentWidgetState extends State<ScaleReglamentWidget> {
  late ScaleReglamentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScaleReglamentModel());
