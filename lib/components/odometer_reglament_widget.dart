...
import 'odometer_reglament_model.dart';
export 'odometer_reglament_model.dart';

class OdometerReglamentWidget extends StatefulWidget {
  const OdometerReglamentWidget({
    super.key,
    required this.json,
  ...
  @override
  State<OdometerReglamentWidget> createState() =>
      _OdometerReglamentWidgetState();
}

class _OdometerReglamentWidgetState extends State<OdometerReglamentWidget> {
  late OdometerReglamentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OdometerReglamentModel());
