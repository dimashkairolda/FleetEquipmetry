  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final equipmentsTreeGetEquipmentsTreeResponse = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                context.pushNamed(LoadingPageCopyWidget.routeName);
              },
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    height: MediaQuery.sizeOf(context).height * 0.127,
                              ...
                              child: Builder(
                                builder: (context) {
                                  final equipTRee = functions
                                      .jsonToList(
                                          equipmentsTreeGetEquipmentsTreeResponse
                                              .jsonBody)
                                      .take(_model.end!)
                                      .toList();
