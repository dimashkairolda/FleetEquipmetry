...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    equip2AuthUserSubject.add(
      Equip2AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Equip2AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Equip2AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Equip2AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    equip2AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
