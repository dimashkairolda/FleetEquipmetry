...
class _CreateDefectFromReglamentWidgetState
  ...
  void initState() {
    ...
    _model.opisanieTextController ??= TextEditingController();
    _model.opisanieFocusNode ??= FocusNode();

    _model.probegTextController ??= TextEditingController(
        text: widget!.probeg != null ? widget!.probeg?.toString() : '');
    _model.probegFocusNode ??= FocusNode();

    _model.motoTextController ??= TextEditingController(
        text: widget!.motohours != null ? widget!.motohours?.toString() : '');
            ...
            Align(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  if (_model.aasd!) {
                    _model.aadefect = await CreateDefectAllIncludedCall.call(
                      ...
                      bodyJson: CreateDefectStruct(
                        ...
                        source: 'REGULATION_${widget!.reglamentid}',
                    ...
                    if ((_model.aadefect?.succeeded ?? true)) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            (_model.aadefect?.jsonBody ?? '').toString(),
                            style: TextStyle(
                  ...
                  FFAppState().photos = [];
                  safeSetState(() {});
                  _model.apiResultph6 = await PutDetailedReglamentCall.call(
                    access: currentAuthenticationToken,
                    id: widget!.reglamentid,
                    work: FFAppState().workspace,
                    jsonJson: functions.addDefectAtIndex(
                        FFAppState()
                            .ReglamentDetailed
                            .map((e) => e.toMap())
                            .toList(),
                        widget!.structureIndex!,
                        widget!.questionIndex!,
                        'defects',
                        DefectsStruct(
                          id: getJsonField(
                            (_model.aadefect?.jsonBody ?? ''),
                            r'''$.id''',
                          ).toString(),
                          title: getJsonField(
                            (_model.aadefect?.jsonBody ?? ''),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              safeSetState(() {
                                                _model.isDataUploading_wwwdw =
                                                    false;
                                                _model.uploadedLocalFile_wwwdw =
                                                    FFUploadedFile(
                                                        bytes:
                                                            Uint8List.fromList(
                                                                []));
