...
class CreateDefectFromReglamentModel
  ...
  // Stores action output result for [Custom Action - checkInternetConnectivity] action in CreateDefectFromReglament widget.
  bool? qqq;
  ...
  ApiCallResponse? aadefect;
  // Stores action output result for [Backend Call - API (PutDetailedReglament)] action in Container widget.
  ...
  bool isDataUploading_wwwdw = false;
  FFUploadedFile uploadedLocalFile_wwwdw =
