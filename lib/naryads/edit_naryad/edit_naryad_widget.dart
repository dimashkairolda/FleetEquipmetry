...
import 'edit_naryad_model.dart';
export 'edit_naryad_model.dart';

class EditNaryadWidget extends StatefulWidget {
  const EditNaryadWidget({
    super.key,
    this.spareparts,
    this.todo,
    this.defectid,
  ...
  static String routeName = 'editNaryad';
  static String routePath = '/editNaryad';

  @override
  State<EditNaryadWidget> createState() => _EditNaryadWidgetState();
}

class _EditNaryadWidgetState extends State<EditNaryadWidget>
    with TickerProviderStateMixin {
  late EditNaryadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditNaryadModel());
            ...
            Align(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  _model.apiResult20i = await EditNaryadsCall.call(
