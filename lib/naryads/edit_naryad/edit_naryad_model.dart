...
import '/index.dart';
import 'edit_naryad_widget.dart' show EditNaryadWidget;
import 'package:flutter/material.dart';

class EditNaryadModel extends FlutterFlowModel<EditNaryadWidget> {
  ...
  // Stores action output result for [Backend Call - API (EditNaryads)] action in Container widget.
