...
import 'create_naryad_maintenance_model.dart';
export 'create_naryad_maintenance_model.dart';

class CreateNaryadMaintenanceWidget extends StatefulWidget {
  const CreateNaryadMaintenanceWidget({
    super.key,
    this.spareparts,
    this.todo,
    this.defectid,
  ...
  static String routeName = 'CreateNaryadMaintenance';
  static String routePath = '/createNaryadMaintenance';

  @override
  State<CreateNaryadMaintenanceWidget> createState() =>
      _CreateNaryadMaintenanceWidgetState();
}

class _CreateNaryadMaintenanceWidgetState
    extends State<CreateNaryadMaintenanceWidget> with TickerProviderStateMixin {
  late CreateNaryadMaintenanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNaryadMaintenanceModel());
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  _model.apiResult20i = await CreateNaryadsCall.call(
                    ...
                    todoJson: functions.formatTodoList(
