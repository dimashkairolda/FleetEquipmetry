...
import 'chooseasset_naryad_model.dart';
export 'chooseasset_naryad_model.dart';

class ChooseassetNaryadWidget extends StatefulWidget {
  const ChooseassetNaryadWidget({super.key});

  static String routeName = 'chooseassetNaryad';
  static String routePath = '/chooseassetNaryad';

  @override
  State<ChooseassetNaryadWidget> createState() =>
      _ChooseassetNaryadWidgetState();
}

class _ChooseassetNaryadWidgetState extends State<ChooseassetNaryadWidget> {
  late ChooseassetNaryadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseassetNaryadModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final chooseassetNaryadGetEquipmentsTreeResponse = snapshot.data!;
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(11, 10, 11, 0),
                            child: Builder(
                              builder: (context) {
                                final equipTRee = functions
                                    .jsonToList(
                                        chooseassetNaryadGetEquipmentsTreeResponse
                                            .jsonBody)
                                    .take(_model.end)
                                    .toList();
