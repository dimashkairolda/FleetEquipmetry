...
import 'defect_naryad_model.dart';
export 'defect_naryad_model.dart';

class DefectNaryadWidget extends StatefulWidget {
  const DefectNaryadWidget({
    super.key,
    this.platenumber,
    this.equipmentname,
  ...
  static String routeName = 'DefectNaryad';
  static String routePath = '/defectNaryad';

  @override
  State<DefectNaryadWidget> createState() => _DefectNaryadWidgetState();
}

class _DefectNaryadWidgetState extends State<DefectNaryadWidget> {
  late DefectNaryadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DefectNaryadModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final defectNaryadGetDefectsAPINaryadResponse = snapshot.data!;
                                        ...
                                        onChanged: (_) => EasyDebounce.debounce(
                                          ...
                                          () async {
                                            ...
                                            FFAppState().searchOutput1 = functions
                                                .filterSearched(
                                                    defectNaryadGetDefectsAPINaryadResponse
                                                        .jsonBody,
